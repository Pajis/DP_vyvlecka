...
output_table = r"D:\vysledky_modelovani_AGB\AGB_table_XGB_all.csv"
model_path = r"D:\vysledky_modelovani_AGB\AGB_model_XGB_all.pkl"
output_raster_path = r"D:\vysledky_modelovani_AGB\AGB_model_XGB_all.tif"
feature_importance_path = r"D:\vysledky_modelovani_AGB\feature_importance_XGB_all.csv"
...
if cnt_null > 0:
 ...
 # === 2. EXTRAKCE RASTROVÝCH HODNOT DO BODŮ (2x2 pixel pro les) + zápis do originálu ===
...
for train_idx, test_idx in outer_cv.split(X, y, groups=groups):
    ...
    model = XGBRegressor(random_state=36, **best_params)
    model.fit(X_tr, y_tr)
...
nested_summary_path = r"D:\vysledky_modelovani_AGB\XGB_all_nested_summary.csv"
...
best_model = XGBRegressor(random_state=36, **final_params)
best_model.fit(X, y)
